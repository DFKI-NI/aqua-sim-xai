...
namespace Unity.Robotics.Core
{
    ...
    {
        // Since UnityScaled is the default Unity Time mode, we'll use that for this
        // project None of the other time modes are fully validated and guaranteed
        // to be without issues
        public enum ClockMode {
            // Time delta scaled by simulation speed to the start of the current
            // frame, since the beginning of the game
            UnityScaled,
            // Real time delta to the exact moment this function is called, since
            // beginning of the game UnityUnscaled, Real time delta since the Unix
            // Epoch (1/1/1970 @ midnight) UnixEpoch, Examples of other potentially
            // useful clock modes... UnixEpochUtc, DateTimeNow, DateTimeNowUtc,
            // ExternalClock
        }
        ...
        static readonly double k_StartTimeEpochSeconds =
            SecondsSinceUnixEpoch - Time.realtimeSinceStartupAsDouble;
        ...
        {
            get {
                return Mode switch {// This might be an approximation... needs testing.
                                    ClockMode.UnityScaled => Time.timeAsDouble,
                                    // ClockMode.UnityUnscaled => Time.unscaledTimeAsDouble,
                                    // ClockMode.UnixEpoch => k_StartTimeEpochSeconds +
                                    // UnityUnscaledTimeSinceFrameStart,
        ...
        public static double NowTimeInSeconds
        {
            get {
                return Mode switch {
                    ClockMode.UnityScaled =>
                        Time.timeAsDouble + UnityUnscaledTimeSinceFrameStart * Time.timeScale,
        ...
        // NOTE: Precision loss vs. other time measurements due to no
        // deltaTimeAsDouble interface
        ...
        // WARNING: These functions could potentially mess up threaded access to
        // this clock class.
        //          Would need to include some mutex locking to keep these calls
        //          thread-safe

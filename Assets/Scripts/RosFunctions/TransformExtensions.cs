...
public static class TransformExtensions
{
    ...
    public static TransformMsg ToROSTransform(this Transform tfUnity)
    {
        return new TransformMsg(
            // Using vector/quaternion To<>() because Transform.To<>() doesn't use
            // localPosition/localRotation
            tfUnity.localPosition.To<FLU>(), tfUnity.localRotation.To<FLU>());
    }
                                                            ...
                                                            double timeStamp)
    {
        return new TransformStampedMsg(
            ...
            tfUnity.gameObject.name, tfUnity.ToROSTransform());
    }
}

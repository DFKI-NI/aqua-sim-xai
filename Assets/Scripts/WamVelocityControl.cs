...
public class WamVelocityControl : MonoBehaviour
{
    ...
    {
        Vector3 movement =
            new Vector3(-lvx * Time.deltaTime, lvz * Time.deltaTime, lvy * Time.deltaTime);
        transform.Translate(movement);
        transform.Rotate(0, avz * Time.deltaTime, 0);
    }
    // TODO: USV shouldn't have Y axis movement (In unity coordinates)
